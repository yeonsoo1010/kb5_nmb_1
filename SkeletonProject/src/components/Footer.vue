<template>
    <button id="question" class="btn btn-warning rounded-circle custom-button" @click="toggleMemo">
        <i class="fa-solid fa-question"></i>
    </button>
    <div v-if="showMemo" class="memo-container">
        <div class="triangle"></div>
        <div class="memo-content">
            💛 가계부 입력 방법 💛 <br />
            <br />
            1. '수입'과 '지출' 버튼 중 원하는 버튼을 누른다 ! <br />
            <br />
            2. 내역, 가격, 카테고리를 입력한 후 추가 버튼을 누른다 ! <br />
            <br />
            3. home 화면으로 돌아오면 끝 !
        </div>
    </div>
    ...
    <!-- 닫는 태그 추가 -->
    <div></div>
    <router-link id="plus" class="btn" to="/home/plus" style="text-align: center"> <i class="fa-solid fa-plus"></i> 수입 </router-link>
    <!-- 닫는 태그 추가 -->
    <div></div>
